...
export const CardView = (data: TriviaView) => {
    return (
        <div id="card" data-id={data.id} key={data.id} className="cursor-pointer p-5 shadow-md hover:bg-gray-50 bg-white border-1 basis-[calc((100%-3rem)/4)] flex gap-3 border-gray-300 rounded-xl ">
